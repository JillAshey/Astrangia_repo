...
cowplot::plot_grid(df$data_plot[[2]], df$thin_data_plot[[2]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))
cowplot::plot_grid(df$data_plot[[3]], df$thin_data_plot[[3]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[5]], df$thin_data_plot[[5]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[7]], df$thin_data_plot[[7]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[8]], df$thin_data_plot[[8]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[11]], df$thin_data_plot[[11]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[12]], df$thin_data_plot[[12]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))




cowplot::plot_grid(df$data_plot[[17]], df$thin_data_plot[[17]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[18]], df$thin_data_plot[[18]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[19]], df$thin_data_plot[[18]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[21]], df$thin_data_plot[[21]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[25]], df$thin_data_plot[[25]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[26]], df$thin_data_plot[[26]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[29]], df$thin_data_plot[[29]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))

cowplot::plot_grid(df$data_plot[[27]], df$thin_data_plot[[27]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))
...
cowplot::plot_grid(df$data_plot[[5]], df$thin_data_plot[[5]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))
cowplot::plot_grid(df$data_plot[[15]], df$thin_data_plot[[15]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))
cowplot::plot_grid(df$data_plot[[40]], df$thin_data_plot[[40]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))
cowplot::plot_grid(df$data_plot[[25]], df$thin_data_plot[[25]], nrow = 2,
                   labels = c("Example plot: all data", "Example plot: thinned data"))
```
...
# Write to output file
write.csv(pr.save, "output/PR_Time0_rates.csv")
```
