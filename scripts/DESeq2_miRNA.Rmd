...
write.csv(TP0_v_5_amb_df, file = "../output/Molecular/smRNA/TP0_v_5_amb_miRNA.csv")
...
# Plot PCA and heatmap of DEMs for this comparison
...
write.csv(TP0_v_7_amb_df, file = "../output/Molecular/smRNA/TP0_v_7_amb_miRNA.csv")
