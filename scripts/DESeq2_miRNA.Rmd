...
#write.csv(filt_outrm_poa, file = "../output/Molecular/smRNA/filtered_miRNA_counts.csv")
```
...
#write.csv(TP0_v_5_heat_df, file = "../output/Molecular/smRNA/TP0_v_5_heat_miRNA.csv")
...
#write.csv(TP0_v_7_heat_df, file = "../output/Molecular/smRNA/TP0_v_7_heat_miRNA.csv")
...
#write.csv(TP5_heat_v_7_heat_df, file = "../output/Molecular/smRNA/TP5_heat_v_7_heat_miRNA.csv")

# Volcano plot for LFC 
ma_plot <- plotMA(TP5_heat_v_7_heat); ma_plot

# Subset miRNAs with significant padj values
sum(TP5_heat_v_7_heat$padj <0.05, na.rm=T) # miRNAs with significant p-values
```
...
#write.csv(TP5_amb_v_TP5_heat_df, file = "../output/Molecular/smRNA/TP5_amb_v_TP5_heat_miRNA.csv")
...
#write.csv(TP7_amb_v_TP7_heat_df, file = "../output/Molecular/smRNA/TP7_amb_v_TP7_heat_miRNA.csv")
...
#write.csv(TP5_heat_v_TP7_amb_df, file = "../output/Molecular/smRNA/TP5_heat_v_TP7_amb_miRNA.csv")
...
There are 37 unique differentially expressed miRNAs. Visualize the differentially expressed miRNAs. 
...
20240901
Also ran shortstack as an miRNA identifier. Look at miRNA DEGs with shortstack output 
