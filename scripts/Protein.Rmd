...
prot <- prot %>% 
  mutate(Month = case_when(
    ...
    Timepoint == "TP5" ~ "June", 
    Timepoint == "TP6" ~ "July", 
    Timepoint == "TP7" ~ "August")) # TP7
```

Remove acclimatization (TP0) and field data 
```{r}
prot <- prot %>%
...
```{r}
prot$Month <- factor(prot$Month, levels = c("March", "Early April", "Late April", "May", "June", "July", "August"))
```
...
ggsave("../output/Physiology/SolubleProtein/SolubleProtein_Treatment_20240108.pdf", plot, width = 10, height = 8)
ggsave("../output/Physiology/SolubleProtein/SolubleProtein_Treatment_20240108.png", plot, width = 10, height = 8)
```
