...
# Save as csv 
write.csv(comparison_df_degs_annot, "../output/Molecular/interactions/miRNA_mRNA_TP0_v_TP5_heat_pcc_lfc_annot.png")
```
...
# Save as csv 
write.csv(comparison_df_degs_annot, "../output/Molecular/interactions/miRNA_mRNA_TP0_v_TP7_amb_pcc_lfc_annot.png")
```
