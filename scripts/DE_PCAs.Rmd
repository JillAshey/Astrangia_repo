...
# Save plots 
ggsave("../output/Molecular/mRNA/pca_plot_DEGs.pdf", mrna_plot, width = 15, height = 10)
ggsave("../output/Molecular/mRNA/pca_plot_DEGs.png", mrna_plot, width = 15, height = 10)
```
...
# Save plots 
ggsave("../output/Molecular/smRNA/pca_plot_DEMs.pdf", mirna_plot, width = 15, height = 10)
ggsave("../output/Molecular/smRNA/pca_plot_DEMs.png", mirna_plot, width = 15, height = 10)
```
