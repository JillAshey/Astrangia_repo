...
Script for plotting PCAs for differential expression of mRNAs and miRNAs
...
# Set levels
pca_data$Month <- factor(pca_data$Month, levels = c("February", "June", "August"))
...
```{r}
combined_plot <- mrna_plot + mirna_plot + 
  plot_layout(guides = "collect") + 
  plot_annotation(tag_levels = 'A') & 
  theme(
    plot.tag = element_text(size = 40, face = "bold"),
    plot.margin = margin(t = 20, r = 20, b = 20, l = 20)); combined_plot

# Save
ggsave("../output/Molecular/pca_plot_deg_dem.pdf", combined_plot, width = 15, height = 8)
ggsave("../output/Molecular/pca_plot_deg_dem.png", combined_plot, width = 15, height = 8)
```
