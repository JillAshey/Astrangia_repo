# Title: Apex plotting (data from 20210201 - 20210209)
# Author: Jill Ashey
# date: 1/12/2021

## Apex data from GSO astrangia experiment 
# data from 20210201 - 20210209
...
# Read in xml info
xmlfile <- xmlParse("http://131.128.103.229:80/cgi-bin/datalog.xml?sdate=210201&days=9") #read in the date plus x days of Apex data
...
pdf("~/Desktop/PutnamLab/Repositories/Astrangia_repo/Astrangia_repo/output/Apex/20210209_Apex_Plot_Output.data.pdf")
#par(mfrow=c(2,1))
