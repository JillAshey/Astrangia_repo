...
Read in data. Positive LFC = upregulated in TP5 heat treatment. Negative LFC = upregulated in TP5 ambient treatment
```{r}
...
Subset genes that are upregulated in TP5 heat treatment (ie positive LFC)
```{r}
...
Subset genes that are upregulated in TP5 ambient treatment (ie negative LFC)
```{r}
...
# Save as csv 
write.csv(GO_En_sig_gene, "../output/Molecular/mRNA/enrichment/GO_en_sig_June_amb_expressed_genes.csv")
```
