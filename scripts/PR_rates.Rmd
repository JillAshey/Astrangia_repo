...
sample.info <- read_csv(file = "data/Physiology/PR/PR_sample_metadata.csv")
...
ggsave("output/PR/Timepoint.Treatment_PR.pdf", plot, width = 6, height = 5, units = c("in"))
