...
## Stats 
```{r}
## Read in metadata to get site info 
...
## remove field corals for now 
pr_exp <- all[!str_detect(all$Treatment, "Field"),]
pr_exp <- pr_exp %>% 
  dplyr::rename(PlugID = colony_id)


# Merge w/ metadata 
pr_exp <- left_join(pr_exp, master)
```
