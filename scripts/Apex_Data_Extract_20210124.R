...
# Data Extracted from 20210118 - 20210124
...
# Read in xml info
xmlfile <- xmlParse("http://131.128.103.229:80/cgi-bin/datalog.xml?sdate=210118&days=7") #read in the date plus x days of Apex data
...
write.csv(Probe.Data, "~/Desktop/PutnamLab/Repositories/Astrangia_repo/Astrangia_repo/data/Apex/20210124_Apex_Data_Output.data.csv") #write file to save data

# Plot Temp and save to output
# CHANGE DATE FOR NEW PDF (risk overwritting previous)
pdf("~/Desktop/PutnamLab/Repositories/Astrangia_repo/Astrangia_repo/output/Apex/20210124_Apex_Plot_Output.data.pdf")
#par(mfrow=c(2,1))
