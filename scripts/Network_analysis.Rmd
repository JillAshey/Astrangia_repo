...
detailed_turnover_long <- detailed_turnover %>%
  pivot_longer(
    cols = c(conserved_stable, conserved_magnitude_change, 
...
p_enhanced_turnover <- ggplot(detailed_turnover_long, 
  ...
  labs(
    ...
    subtitle = "Conserved edges split by stability, magnitude change, and sign flip",
    x = "Comparison",
    y = "Number of Edges"
  ) +
  theme_minimal() +
...
detailed_turnover_pct <- detailed_turnover %>%
  mutate(
    total_edges = conserved_stable + conserved_magnitude_change + 
                  conserved_sign_flip + lost + gained,
...
print(detailed_turnover_pct %>% 
        dplyr::select(comparison, pct_conserved_stable, pct_conserved_magnitude, 
...
sign_flip_summary <- detailed_turnover %>%
  mutate(
    total_conserved = conserved_stable + conserved_magnitude_change + conserved_sign_flip,
