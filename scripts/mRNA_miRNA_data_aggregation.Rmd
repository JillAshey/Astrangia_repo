...
Plot 
```{r}
ggplot(combined_data_pcc, aes(x = PCC.cor, y = p_value, color = p_value < 0.05)) +
  #geom_point(alpha = 0.5) +  # Add points with some transparency
  geom_jitter(alpha = 0.5, width = 0.05, height = 0) +  # Jitter points horizontally
  scale_color_manual(values = c("FALSE" = "black", "TRUE" = "red")) +
  geom_hline(yintercept = 0.05, linetype = "dashed", color = "blue") +  # Add horizontal line at y = 0.05
  theme_minimal() +
  labs(x = "Pearson Correlation Coefficient",
       y = "P-value",
       color = "P-value < 0.05") 
# If you want to remove the legend, add:
...
Plot PCC vs pvalue
```{r}
ggplot(combined_data_pcc_mrna_mirna_de, aes(x = PCC.cor, y = p_value, color = p_value < 0.05)) +
  #geom_point(alpha = 0.5) +  # Add points with some transparency
  geom_jitter(alpha = 0.5, width = 0.05, height = 0) +  # Jitter points horizontally
  scale_color_manual(values = c("FALSE" = "black", "TRUE" = "red")) +
  geom_hline(yintercept = 0.05, linetype = "dashed", color = "blue") +  # Add horizontal line at y = 0.05
