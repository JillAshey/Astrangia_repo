...
sum(TP0_v_5_amb.sig$log2FoldChange <0, na.rm=T) # genes downregulated in TP5 ambient relative to TP0 ambient
...
sum(TP0_v_7_amb.sig$log2FoldChange <0, na.rm=T) # genes are downregulated in TP5 ambient relative to TP0 ambient
