...
sum(TP0_v_5_amb$padj <0.05, na.rm=T) # 675 genes with significant p-values
TP0_v_5_amb.sig <- subset(TP0_v_5_amb, padj<0.05,) #identify signficant pvalues with 5%FDR
sum(TP0_v_5_amb.sig$log2FoldChange <0, na.rm=T) # 520 genes are downregulated in TP5 ambient relative to TP0 ambient
sum(TP0_v_5_amb.sig$log2FoldChange >0, na.rm=T) # 155 genes are upregulated in TP5 ambient relative to TP0 ambient
...
sum(TP0_v_7_amb$padj <0.05, na.rm=T) # 690 genes with significant p-values
TP0_v_7_amb.sig <- subset(TP0_v_7_amb, padj<0.05,) #identify signficant pvalues with 5%FDR
sum(TP0_v_7_amb.sig$log2FoldChange <0, na.rm=T) # 460 genes are downregulated in TP5 ambient relative to TP0 ambient
sum(TP0_v_7_amb.sig$log2FoldChange >0, na.rm=T) # 230 genes are upregulated in TP5 ambient relative to TP0 ambient
...
sum(TP5_v_7_amb$padj <0.05, na.rm=T) # 189 genes with significant p-values
TP5_v_7_amb.sig <- subset(TP5_v_7_amb, padj<0.05,) #identify signficant pvalues with 5%FDR
sum(TP5_v_7_amb.sig$log2FoldChange <0, na.rm=T) # 58 genes are downregulated in TP7 ambient relative to TP5 ambient
sum(TP5_v_7_amb.sig$log2FoldChange >0, na.rm=T) # 131 genes are upregulated in TP7 ambient relative to TP5 ambient
...
sum(TP0_v_5_heat$padj <0.05, na.rm=T) # 613 genes with significant p-values
TP0_v_5_heat.sig <- subset(TP0_v_5_heat, padj<0.05,) #identify signficant pvalues with 5%FDR
sum(TP0_v_5_heat.sig$log2FoldChange <0, na.rm=T) # 424 genes are downregulated in TP5 heat relative to TP0 ambient
sum(TP0_v_5_heat.sig$log2FoldChange >0, na.rm=T) # 189 genes are upregulated in TP5 heat relative to TP0 ambient
...
sum(TP0_v_7_heat$padj <0.05, na.rm=T) # 954 genes with significant p-values
TP0_v_7_heat.sig <- subset(TP0_v_7_heat, padj<0.05,) #identify signficant pvalues with 5%FDR
sum(TP0_v_7_heat.sig$log2FoldChange <0, na.rm=T) # 593 genes are downregulated in TP7 heat relative to TP0 ambient
sum(TP0_v_7_heat.sig$log2FoldChange >0, na.rm=T) # 361 genes are upregulated in TP7 heat relative to TP0 ambient
...
sum(TP5_heat_v_7_heat$padj <0.05, na.rm=T) # 66 genes with significant p-values
TP5_heat_v_7_heat.sig <- subset(TP5_heat_v_7_heat, padj<0.05,) #identify signficant pvalues with 5%FDR
sum(TP5_heat_v_7_heat.sig$log2FoldChange <0, na.rm=T) # 21 genes are downregulated in TP7 heat relative to TP5 heat
sum(TP5_heat_v_7_heat.sig$log2FoldChange >0, na.rm=T) # 45 genes are upregulated in TP7 heat relative to TP5 heat
...
sum(TP5_amb_v_TP5_heat$padj <0.05, na.rm=T) # 107 genes with significant p-values
TP5_amb_v_TP5_heat.sig <- subset(TP5_amb_v_TP5_heat, padj<0.05,) #identify signficant pvalues with 5%FDR
sum(TP5_amb_v_TP5_heat.sig$log2FoldChange <0, na.rm=T) # 48 genes are downregulated in TP5 heat relative to TP5 amb
sum(TP5_amb_v_TP5_heat.sig$log2FoldChange >0, na.rm=T) # 59 genes are upregulated in TP5 heat relative to TP5 amb
...
sum(TP7_amb_v_TP7_heat$padj <0.05, na.rm=T) # 74 genes with significant p-values
TP7_amb_v_TP7_heat.sig <- subset(TP7_amb_v_TP7_heat, padj<0.05,) #identify signficant pvalues with 5%FDR
sum(TP7_amb_v_TP7_heat.sig$log2FoldChange <0, na.rm=T) # 51 genes are downregulated in TP7 heat relative to TP7 amb
sum(TP7_amb_v_TP7_heat.sig$log2FoldChange >0, na.rm=T) # 23 genes are upregulated in TP7 heat relative to TP7 amb
...
pdf("../output/Molecular/mRNA/heatmap_DEGs.pdf", width = 8, height = 10)
print(heatmap)
dev.off()
```
