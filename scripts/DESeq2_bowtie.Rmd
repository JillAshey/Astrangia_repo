...
sum(TP5_v_7_amb.sig$log2FoldChange <0, na.rm=T) # genes downregulated in TP7 ambient relative to TP5 ambient
...
sum(TP0_v_5_heat.sig$log2FoldChange <0, na.rm=T) # genes downregulated in TP5 heat relative to TP0 ambient
...
sum(TP0_v_7_heat.sig$log2FoldChange <0, na.rm=T) # genes downregulated in TP7 heat relative to TP0 ambient
...
sum(TP5_heat_v_7_heat.sig$log2FoldChange <0, na.rm=T) # genes downregulated in TP7 heat relative to TP5 heat
...
sum(TP5_amb_v_TP5_heat.sig$log2FoldChange <0, na.rm=T) # genes downregulated in TP5 heat relative to TP5 amb
...
sum(TP7_amb_v_TP7_heat.sig$log2FoldChange <0, na.rm=T) # genes downregulated in TP7 heat relative to TP7 amb
