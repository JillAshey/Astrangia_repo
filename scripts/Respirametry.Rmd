...
sample.info <- read_csv(file = "data/PR/Time0/PR_T0_sample_metadata.csv")

# Load PI curve run metadata (i.e., light levels and interval times for each run)
run.info <- read_csv(file = "data/PR/Time0/PR_T0_run_metadata.csv")
...
## Photosynthesis and respiration - TIME 1
```{r}
##### PHOTOSYNTHESIS AND RESPIRATION #####
  
# get file path
path.p <- "data/PR/Time1" #the location of all your respirometry files 
...
# Load PI curve sample metadata (i.e., which corals were in which runs)
sample.info <- read_csv(file = "data/PR/Time1/PR_T1_sample_metadata.csv")

# Load PI curve run metadata (i.e., light levels and interval times for each run)
run.info <- read_csv(file = "data/PR/Time1/PR_T1_run_metadata.csv")
...
# Write to output file
write.csv(pr.save, "output/PR_Time1_rates.csv")
```
