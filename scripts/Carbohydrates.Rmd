...
month_letters_manual <- tibble::tibble(
  ...
  y_position = c(2.83, 3.80, 4.66, 3.22, 3.73, 4.60, 2.83, 2.39))# 0.2 offset from highest sd 
```
...
ggsave("../output/Physiology/Carbohydrates/Carbohydrates_Treatment_Timepoint_dotwhisker_sem.pdf", carb_dot_sem, width = 22, height = 12)
ggsave("../output/Physiology/Carbohydrates/Carbohydrates_Treatment_Timepoint_dotwhisker_sem.png", carb_dot_sem, width = 22, height = 12)
