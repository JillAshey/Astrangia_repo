...
ggsave("../output/Environmental/MyData_NOAA_temperature_smooth.png", temp_plot, width=20, height=14, dpi = 300)
ggsave("../output/Environmental/MyData_NOAA_temperature_smooth.pdf", temp_plot, width=20, height=14, dpi = 300)
```
...
ggsave("../output/Environmental/MolecularAmbientData_NOAA_temperature_smooth.png", temp_plot, width=20, height=14, dpi = 300)
ggsave("../output/Environmental/MolecularAmbientData_NOAA_temperature_smooth.pdf", temp_plot, width=20, height=14, dpi = 300)
```
