...
temp_plot <- ggplot(data = noaa_data, aes(x=Date.Time, y=Temperature))+
  ...
  geom_vline(xintercept=as.POSIXct("2021-06-25 13:30:00", tz = "EST"), linetype="dashed", color="lightgrey", size = 4)+ # TP5 
...
ggsave("../output/Environmental/NOAA_temperature_smooth_TP0_7.png", temp_plot, width=20, height=13)
ggsave("../output/Environmental/NOAA_temperature_smooth_TP0_7.pdf", temp_plot, width=20, height=13)
```
...
ggsave("../output/Environmental/MyData_NOAA_temperature_smooth_TP0_5_7.png", temp_plot, width=20, height=13)
ggsave("../output/Environmental/MyData_NOAA_temperature_smooth_TP0_5_7.pdf", temp_plot, width=20, height=13)
```
