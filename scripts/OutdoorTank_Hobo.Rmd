...
# Read in data 
```{r}
aframe <- read.csv("data/Hobo/temp_light_logger/Outdoor/A-frame_20210630.csv", header=T, na.strings = "NA")[ ,2:4] 
...
ggplot(aframe, aes(x=Date.Time, y=Temperature)) +
  ...
  #ylim(5,15)+
  ylab("Temperature °C")
ggsave("output/Hobo/temp_light_logger/A-frametemp_20210630.pdf", plot = last_plot(), width = 8, height = 4)
...
# Read in data 
```{r}
outdoor <- read.csv("data/Hobo/temp_light_logger/Outdoor/OutdoorTank_20210701.csv", header=T, na.strings = "NA")[ ,2:4] # data from 20201221 onward
