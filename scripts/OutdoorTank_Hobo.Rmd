...
# Read in data 
```{r}
aframe <- read.csv("data/Hobo/temp_light_logger/Outdoor/A-frame_20210718.csv", header=T, na.strings = "NA")[ ,2:4] 
...
# Read in data 
```{r}
outdoor <- read.csv("data/Hobo/temp_light_logger/Outdoor/OutdoorTank_20210718.csv", header=T, na.strings = "NA")[ ,2:4] # data from 20201221 onward
