...
par(mfrow=c(2,3))
plot(SW.chem$Tank, SW.chem$Temperature, xlab="Tank", ylab="Temperature°C", ylim = c(5,10.5), las = 2)
plot(SW.chem$Tank, SW.chem$Salinity, xlab="Tank", ylab="Salinity psu", ylim = c(30,32.5), las = 2)
plot(SW.chem$Tank, SW.chem$pH.Total, xlab="Tank", ylab="pH Total Scale", ylim = c(8,8.5), las = 2)
plot(SW.chem$Tank, SW.chem$Light, xlab="Tank", ylab="Light µmol photons m^2 s^-1", ylim=c(80,120),las=2)
...
#mod.flow <- aov(Flow ~ Tank, data = SW.chem)
#mod.flow
#summary(mod.flow)
