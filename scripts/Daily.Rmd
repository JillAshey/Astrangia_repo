...
par(mfrow=c(2,3))
plot(SW.chem$Tank, SW.chem$Temperature.C, xlab="Tank", ylab="Temperature°C", ylim = c(3.5,15), las = 2)
plot(SW.chem$Tank, SW.chem$Salinity.psu, xlab="Tank", ylab="Salinity psu", ylim = c(30,34), las = 2)
...
plot(SW.chem$Tank, SW.chem$Flow.mL.sec, xlab="Tank", ylab="Flow mL/sec", ylim=c(2,20),las=2)
dev.off()
