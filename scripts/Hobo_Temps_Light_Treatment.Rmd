...
# Tank1
Tank1 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank1_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 2/6/21 onward
colnames(Tank1) <- c("Date", "Temperature", "Light")
Tank1$Date <- parse_date_time(Tank1$Date, "mdyHMS", tz = "EST")
# Tank2
Tank2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank2_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 2/6/21 onward
...
# Tank3
Tank3 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank3_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 2/6/21 onward
...
# Tank4
Tank4 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank4_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 2/6/21 onward
#Tank3 <- Tank3[1:nrow(Tank1),]
...
Tank5.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank5_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank6.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank6_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank7.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank7_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank8.3 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank8_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 5/15/21 onward
...
Tank9.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank9_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank10.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank10_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank11.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank11_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank12.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank12_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank16.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank16_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank17.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank17_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank18.2 <- read.csv("data/Hobo/temp_light_logger/20210820/Tank17_20210820.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
