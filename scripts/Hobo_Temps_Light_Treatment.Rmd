...
# Read in data 
# Tank1
Tank1 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank1_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 2/6/21 onward
colnames(Tank1) <- c("Date", "Temperature", "Light")
Tank1$Date <- parse_date_time(Tank1$Date, "mdyHMS", tz = "EST")
#Tank1$Treatment <- "Ambient"
# Tank2
Tank2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank2_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 2/6/21 onward
...
# Tank3
Tank3 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank3_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 2/6/21 onward
...
# Tank4
Tank4 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank4_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 2/6/21 onward
#Tank3 <- Tank3[1:nrow(Tank1),]
colnames(Tank4) <- c("Date", "Temperature", "Light")
Tank4$Date <- parse_date_time(Tank4$Date, "mdyHMS", tz = "EST")
#Tank4$Treatment <- "Heat"
...
Tank5.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank5_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank6.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank6_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank7.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank7_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank8.2 <- read.csv("data/Hobo/temp_light_logger/20210524/Tank8_20210524.csv", sep=",", skip = c(2), header=T, na.strings = "NA")[ ,1:3] # data from 2/6/21 to 4/30/21
colnames(Tank8.2) <- c("Date", "Temperature", "Light")
Tank8.3 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank8_20210606.csv", sep=",", skip = c(2), header=T, na.strings = "NA")[ ,1:3] # data from 2/6/21 to 4/30/21
...
Tank9.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank9_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank10.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank10_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank11.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank11_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank12.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank12_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank15.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank15_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
colnames(Tank15.2) <- c("Date", "Temperature", "Light")
Tank15.full <- rbind(Tank15.1, Tank15.2) # bind data from Tank 5 together
Tank15.full <- Tank15.full %>% 
  mutate(Date = parse_date_time(Date, orders = c('ymdHMS', "mdyHMS"), tz = "EST"))
#Tank15.full$Treatment <- "Heat"
...
Tank16.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank16_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank17.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank17_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
Tank18.2 <- read.csv("data/Hobo/temp_light_logger/20210606/Tank17_20210606.csv", sep=",", header=T, na.strings = "NA")[ ,2:4] # data from 4/30/21 onward
...
colnames(temp.data) <- c("Date.Time", 
                     ...
                     "Tank17", 
                     "Tank18")
temp.data$Tank8 <- as.double(temp.data$Tank8)
...
light.data$Tank5 <- as.double(light.data$Tank5)
light.data$Tank6 <- as.double(light.data$Tank6)
light.data$Tank7 <- as.double(light.data$Tank7)
